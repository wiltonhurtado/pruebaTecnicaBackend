...
<nav class="navbar navbar-inverse navegacion navbar-fixed-top">
  ...
  <h1>WELCOME</h1>
  <h4>Ahora por favor loguese con su email y contraseña registrados</h4>
  ...
  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
  <form method="post" action="{{route('welcome.authenticate')}}" name="formulario" id="formulario">
      @csrf
    ...
    <br>
   <small> olvido su contraseña? use el siguienete link para poder reestablecerla</small><br>
<a href="index" style="color: steelblue;">link para reestablecer contraseña </a>
<br>
 ...
 @error('mail')
    ...
    @enderror
                    ...
                    <div align="center">
                      ...
                      <button class="btn  btn-success" type="submit" id="iniciar" name="iniciar" tabindex="-1">Iniciar sesión</button>
